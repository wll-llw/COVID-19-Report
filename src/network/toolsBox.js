import {request, RumourList, anotherRequest, institutions, Transfer, NcpHospList, vaccineData, vaccineNewsList} from './request'
...
export function getNcpHospList() { // 获取接种医院列表
  return NcpHospList({
    method: 'post',
    headers: {
      'Content-Type': 'application/json'
    },
    url: '/api/NcpVaccineService/getNcpHospList',
  })
}
